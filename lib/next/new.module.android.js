...
function startForegroundService() {
  return new Promise((resolve, reject) => {
    BeaconsManager.startForegroundService(resolve, reject);
  });
}

function stopForegroundService(){
  return new Promise((resolve, reject) => {
    BeaconsManager.stopForegroundService(resolve, reject);
  });
}
 ...
 *
 */
function detectCustomBeaconLayout(parser: string): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(parser, resolve, reject);
  });
}

function addCustomBeaconLayoutDetection(parser: string): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(parser, resolve, reject);
  });
}
